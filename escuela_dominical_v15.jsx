...
function flipName(str) {
  ...
  const primerNombres = ["josé","jose","juan","maría","maria","carlos","pedro","ana","diana","luz","martha","mabel","deisy","blanca","verónica","veronica","andrés","andres","alejandro","samuel","valeria","cindy","astrid","lucy","michael","rosy","ángel","angelo","david","daniel","javier","josé luís","jose luis"];
...
const CRITERIOS = [
  ...
  {logro:"CONOCIMIENTO",key:"conocimiento",item:"Historias bíblicas"},
  {logro:"ORACIÓN",key:"oracion",item:"Hábito de oración"},
  {logro:"SERVICIO",key:"servicio",item:"Compartir y ayudar"},
  {logro:"RESPETO",key:"respeto",item:"Respeto hacia los demás"},
  {logro:"PARTICIPACIÓN",key:"participacion",item:"Actividades grupales"},
...
// Maestros autorizados exclusivamente para la clase ADOLESCENTES (sin auxiliar): José Mogollón, Yuliet Ceballos, Martha Caro, Ana María Hernández, José Hernán Díaz
...
// Helpers para config dinámica de clases
